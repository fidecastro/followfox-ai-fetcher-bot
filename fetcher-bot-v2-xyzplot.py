...
@bot.slash_command(name="create-xyz", guild_ids=SERVER_ID, description="Create a XYZ plot for Vodka-V2", interaction_response_message="Creating XYZ Plot. Please wait...")
